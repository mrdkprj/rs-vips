...
impl VipsImage {
    ...
    pub fn draw_circle(&mut self, ink: &[f64], cx: i32, cy: i32, radius: i32) -> Result<()> {
        self.prepare_draw()?;
        let vips_op_response = call(
            "draw_circle",
            VOption::new()
    ...
    pub fn draw_image(&mut self, sub: &VipsImage, x: i32, y: i32) -> Result<()> {
        self.prepare_draw()?;
        let vips_op_response = call(
            "draw_image",
            VOption::new()
    ...
    ///
    /// height: `i32` -> Rect to fill
    pub fn draw_smudge(&mut self, left: i32, top: i32, width: i32, height: i32) -> Result<()> {
        self.prepare_draw()?;
        let vips_op_response = call(
            "draw_smudge",
            VOption::new()
    ...
    /// returns `VipsImage` - Output image
    pub fn linecache(&mut self) -> Result<VipsImage> {
        let mut out_out = VipsImage::from(null_mut());
        let vips_op_response = call(
            "linecache",
            VOption::new()
    ...
    pub fn linecache_with_opts(&mut self, option: VOption) -> Result<VipsImage> {
        let mut out_out = VipsImage::from(null_mut());
        let vips_op_response = call(
            "linecache",
            option
    ...
    /// <ins>Optional arguments</ins>
    ///
    /// in: `&[VipsImage]` -> Array of input images
    ///
    ...
    /// returns `VipsImage` - Output image
    pub fn tilecache(&mut self) -> Result<VipsImage> {
        let mut out_out = VipsImage::from(null_mut());
        let vips_op_response = call(
            "tilecache",
            VOption::new()
    ...
    ///
    /// persistent: `bool` -> Keep cache between evaluations
    pub fn tilecache_with_opts(&mut self, option: VOption) -> Result<VipsImage> {
        let mut out_out = VipsImage::from(null_mut());
        let vips_op_response = call(
            "tilecache",
            option
